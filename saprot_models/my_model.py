...
print(classification_report(labels_seq, preds_seq,labels=idx_to_class.keys(), target_names=class_to_idx.keys()))

print("\nSequence+3Di classification report:")
print(classification_report(labels_struct, preds_struct,labels=idx_to_class.keys(), target_names=class_to_idx.keys()))
